...
import ConnectionUtil from "../../models/Connection/ConnectionUtil.js"
import InvalidConfigException from "../../models/Exceptions/InvalidConfigException.js"
...
describe("testing connection utill", () => {
    ...
    test("if the settingkey was not in the conditions throws an error", async () => {
        ...
        expect(() => ConnectionUtil.loadConnections(setting)).toThrow(WebServerException)
    })
