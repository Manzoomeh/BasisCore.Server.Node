...
import InlineSource from "../renderEngine/Command/Source/InlineSource.js"; 
...
describe("testing InlineSource with Command", () => {
  ...
  test("show the data in inlinesource", async () => {
    printIl.faces.push({
      name: "face1",
      replace: true,
      function: true,
      "row-type": "odd",
      template:
        "<td style='color:green' id='usedforid'><p>  @vocabulary<br></td>",
    });
